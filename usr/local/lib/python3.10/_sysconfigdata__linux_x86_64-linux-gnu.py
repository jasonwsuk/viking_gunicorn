...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--build=x86_64-linux-musl' "
                ...
                "'--without-ensurepip' 'build_alias=x86_64-linux-musl'",
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall   -DTHREAD_STACK_SIZE=0x100000 '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
              '-Wall   -DTHREAD_STACK_SIZE=0x100000',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall   -DTHREAD_STACK_SIZE=0x100000 '
                        '-fno-semantic-interposition -flto -fuse-linker-plugin '
                        '-ffat-lto-objects -flto-partition=none -g -std=c99 '
                        '-Wextra -Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers '
